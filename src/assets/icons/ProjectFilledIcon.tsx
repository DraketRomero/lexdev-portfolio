...
export const ProjectFilledIcon = ({ width=24, height=15, className }: IIconProps) => <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width={width} height={height} className={className}>
