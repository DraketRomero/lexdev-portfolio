...
export const MockitoIcon = ({ width = 24, height = 24 }: IIconProps) => <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="currentColor" viewBox="0 0 24 24" className="icon icon-tabler icons-tabler-filled icon-tabler-leaf">
